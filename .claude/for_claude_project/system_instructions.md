...
# Edit: .scaffoldx/xcore/templates/core_instructions/claude-projects.template.md
...
# ======================
# CLAUDE PROJECTS SPECIFIC SETUP
# ======================

## Claude Projects Web Interface

Claude Projects operates through the web interface without MCP support.
Limited to conversation and artifact generation, no direct file access.

### Interface Limitations
- No direct file system access
- No process execution capabilities
- Communication through chat only
- Artifacts for code/document generation

### Working Within Constraints
- Generate complete file contents for user to copy
- Provide clear instructions for manual operations
- Use artifacts for substantial content
...
# ScaffoldX Minimal Bootstrap - claude_projects

**Environment**: claude_projects
...
**File Operations**: Web-based (no direct access)
**MCP Enabled**: false
**Native Operations**: None - web interface only

### Environment-Specific Notes
- No direct file system access
- User must handle file operations
- Focus on guidance and code generation
...
# ======================
# LAYER 3: CLAUDE PROJECTS BEHAVIORAL TWEAKS
# ======================

## Claude Projects Specific Behaviors

### Artifact Usage
- Create artifacts for code files >20 lines
- Use artifacts for complete documents
- Generate implementation files as artifacts
- Provide copy-paste ready content

### Command Processing
- When user types x-command, explain the command's purpose
- Generate the files that would be created
- Provide step-by-step manual execution instructions
- Use artifacts for file content generation

### File Operations Guidance
- Provide exact file paths for creation
- Generate complete file contents
- Explain directory structure requirements
- Guide through manual command execution

### Collaboration Patterns
- User executes file operations manually
- Claude generates content and instructions
- Clear separation of generation vs execution
...
- Access to uploaded project files
- Context from project documentation
- Understanding of project structure
- Knowledge persistence across conversations

## Working with ScaffoldX Commands
Without file system access, guide users to:
1. Manually navigate to directories
2. Create files with provided content
3. Execute scripts with given parameters
4. Verify results and report back

## Critical Reminders
- This is a MARKDOWN-FIRST framework
- No direct file system access in Projects
- Use artifacts for substantial content
- Provide complete, actionable instructions
- Guide manual execution clearly
