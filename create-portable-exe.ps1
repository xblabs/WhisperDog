# WhisperDog Portable EXE Creator (PowerShell)
...
Write-Host "WhisperDog Portable EXE Builder" -ForegroundColor Cyan
Write-Host "================================" -ForegroundColor Cyan
Write-Host ""

# Step 1: Build JAR if needed
if (-not $SkipBuild) {
    if (-not (Test-Path "target\whisperdog-2.0.0-jar-with-dependencies.jar")) {
...
# Step 3: Create EXE
Write-Host "[3/3] Creating WhisperDog.exe with Launch4j..." -ForegroundColor Yellow
...
if (-not (Test-Path "WhisperDog.exe")) {
    Write-Host "✗ WhisperDog.exe was not created!" -ForegroundColor Red
    exit 1
}

Write-Host ""
Write-Host "======================================" -ForegroundColor Green
Write-Host "SUCCESS! WhisperDog.exe created!" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
Write-Host "📌 To pin to taskbar:" -ForegroundColor White
Write-Host "   1. Right-click WhisperDog.exe" -ForegroundColor Cyan
...
Write-Host "   %APPDATA%\WhisperDog\config.properties" -ForegroundColor Cyan
