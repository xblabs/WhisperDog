...
import org.whisperdog.postprocessing.ProcessingUnit;
import org.whisperdog.postprocessing.Pipeline;
import org.whisperdog.postprocessing.ProcessingStepData;
import org.whisperdog.postprocessing.PipelineUnitReference;
...
public class ConfigManager {
    ...
    private File getConfigFilePath() {
        ...
        if (osName.contains("win")) {
            configDirPath = System.getenv("APPDATA") + File.separator + "WhisperDog";
        } else if (osName.contains("mac")) {
            configDirPath = System.getProperty("user.home") + File.separator + "Library" + File.separator + "Application Support" + File.separator + "WhisperDog";
        } else {
            configDirPath = System.getProperty("user.home") + File.separator + "WhisperDog" + File.separator + ".config";
    ...
    public String getConfigDirectory() {
        ...
        if (System.getProperty("os.name").toLowerCase().contains("win")) {
            configDir = System.getenv("APPDATA") + File.separator + "WhisperDog";
        } else if (System.getProperty("os.name").toLowerCase().contains("mac")) {
            configDir = System.getProperty("user.home") + File.separator + "Library" + File.separator + "Application Support" + File.separator + "WhisperDog";
        } else {
            configDir = userHome + File.separator + "WhisperDog" + File.separator + ".config";
        }
        return configDir;
    }
