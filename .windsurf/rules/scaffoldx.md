---
title: Windsurf IDE Instructions - Polymorphic Template
environment: windsurf
ide_integration: true
generated: 2025-12-26T15:01:58.780Z
---

# ScaffoldX Configuration for Windsurf IDE
# ==========================================
# IMPORTANT: This file is generated from templates - DO NOT EDIT DIRECTLY
# Edit: .scaffoldx/xcore/templates/core_instructions/windsurf.template.md
...
# ======================
# WINDSURF IDE SPECIFIC SETUP
# ======================

## Windsurf Native Integration

Windsurf provides AI-powered development with deep IDE integration.
...
# ScaffoldX Minimal Bootstrap - windsurf
...
# ======================
# LAYER 3: WINDSURF BEHAVIORAL TWEAKS
# ======================

## Windsurf Specific Behaviors
...
- Use native IDE APIs for file operations
- Execute scripts through IDE's process manager
- Maintain workspace consistency

### File Operations
- Use Windsurf's file system APIs
- Respect .windsurfignore patterns
- Integrate with IDE's change tracking
- Support multi-file atomic operations

### Performance Optimizations
- Leverage IDE's code indexing
- Use cached parse trees
...
- Windsurf has native IDE integration
- Use IDE features for optimal performance
- Maintain workspace consistency
- Respect IDE configuration

---
Generated from template: windsurf.template.md
