# WhisperDog v1.5.0-xblabs Release Notes

## 🎉 Major Release: Enhanced Stability, Diagnostics & Pipeline Optimization

This release represents a significant milestone for the xblabs fork of WhisperDog, focusing on rock-solid UI state management, intelligent audio processing, and comprehensive diagnostics to help users optimize their workflow.
...
### Build from Source
```bash
git clone https://github.com/xblabs/whisperdog-xb.git
cd whisperdog-xb
...
This release builds on the excellent foundation of the original WhisperDog project by [ddxy](https://github.com/ddxy/whisperdog), with significant enhancements by [xblabs](https://github.com/xblabs).
...
- **Repository:** [https://github.com/xblabs/whisperdog-xb](https://github.com/xblabs/whisperdog-xb)
- **Original Project:** [https://github.com/ddxy/whisperdog](https://github.com/ddxy/whisperdog)
- **Pipeline Optimization Guide:** [docs/PIPELINE_OPTIMIZATION.md](docs/PIPELINE_OPTIMIZATION.md)
- **Issues:** [Report bugs or request features](https://github.com/xblabs/whisperdog-xb/issues)
...
**Full Changelog:** [All commits since last release](https://github.com/xblabs/whisperdog-xb/compare/v1.4.0...v1.5.0-xblabs)
