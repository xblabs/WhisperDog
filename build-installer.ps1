# WhisperDog Windows Installer Build Script (PowerShell)
...
Write-Host "WhisperDog Windows Installer Builder" -ForegroundColor Cyan
...
# Verify JAR exists
$jarPath = "target\whisperdog-2.0.0-jar-with-dependencies.jar"
...
Write-Host "installer-output\WhisperDog-2.0.0.exe" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
Write-Host "You can now distribute this installer to users." -ForegroundColor White
Write-Host "It will install WhisperDog with Start Menu shortcuts." -ForegroundColor White
Write-Host ""
