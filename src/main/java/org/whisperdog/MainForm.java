...
import org.whisperdog.postprocessing.PostProcessingListForm;
import org.whisperdog.postprocessing.PostProcessingForm;
import org.whisperdog.postprocessing.PipelineListForm;
import org.whisperdog.postprocessing.PipelineEditorForm;
import org.whisperdog.postprocessing.UnitLibraryListForm;
import org.whisperdog.postprocessing.UnitEditorForm;
    ...
    private void initMenuEvent() {
        menu.addMenuEvent((int index, int subIndex, MenuAction action) -> {
            ...
            if (index == 0) {
                ...
                // Refresh pipelines and device labels in case settings changed
